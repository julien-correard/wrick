...
#define GAME_PERIOD 32  /* logic period in ms (~31hz); override at runtime with -speed */
...
extern U8 game_drewpf;     /* last tick drew the playfield (TRUE, FALSE) */
