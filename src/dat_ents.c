...
entdata_t ent_entdata[ENT_NBR_ENTDATA] = {
  ...
  {0x12, 0x15, 0x0092, 0x0067, 0x04, 0x04, 0x1A},
  {0x12, 0x15, 0x0092, 0x006a, 0x18, 0x04, 0x1A},
  {0x18, 0x15, 0x000a, 0x006c, 0x04, 0x04, 0x14},
  {0x18, 0x15, 0x0046, 0x0071, 0x04, 0x04, 0x1A},
  {0x12, 0x10, 0x0088, 0x0074, 0x04, 0x04, 0x17},
  {0x12, 0x10, 0x008d, 0x0074, 0x04, 0x04, 0x17},
  ...
  {0x12, 0x15, 0x0092, 0x008e, 0x18, 0x04, 0x1A},
  ...
  */
  ...
  /* 0x4b : slow-fire bullet trap (like 57 but with a post-shot reload) */
  {0x10, 0x08, 0x0057, 0x0007, 0x10, 0x04, 0x1C},
  /* 0x4c : slow-fire missile trap (like 63 but with a post-shot reload) */
  {0x20, 0x08, 0x0075, 0x0090, 0x14, 0x04, 0x15},
  /* 0x4d : RUxF life bonus (sprite 213, 0x00d5, empty until drawn in the editor) */
  {0x18, 0x15, 0x00d5, 0x00d5, 0x04, 0x04, 0x00},
};
...
U8 ent_sprseq[ENT_NBR_SPRSEQ] = {
  ...
  /* door destruction animations (54: sprites 113,185-187, 55: sprites 114,188-190) */
  113, 185, 186, 187, 0xff,
  114, 188, 189, 190, 0xff,
  /* barrel 4-frame rolling animation (ent 0x4a): 
     forward (left) base 0x92: sprites 106,150,107,151, x3
     reversed (right) base 0x9f: sprites 106,151,107,150, x3 */
  106, 106, 106, 150, 150, 150, 107, 107, 107, 151, 151, 151, 0xff,
  106, 106, 106, 151, 151, 151, 107, 107, 107, 150, 150, 150, 0xff,
};
